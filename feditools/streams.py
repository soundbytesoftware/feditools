...
class Link:
    ...
    def from_data(cls, data):
        return cls(data["href"], href_lang=data.get("hreflang"), media_type=data.get("mediaType"),
                   name=data.get("name"), id=data.get("id"), width=data.get("width"),
                   height=data.get("height"), preview=data.get("preview"))

    def __init__(self, href, href_lang=None, media_type=None, name=None,
